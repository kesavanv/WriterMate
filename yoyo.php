...
<script type="text/javascript">
	$(function(){
			...
			var $tabs = $('#tabs').tabs();
			$tabs.tabs('select', 1);
			$( "a#diapers" ).click(function() { window.location.href="index.php"; });
...
<form action="yoyo_form.php" method="post">
	...
	<div id="tabs">
		<ul>
			<li><a href="index.php" id="diapers">Diapers</a></li>
			<li><a href="#tabs-2" id="yoyo">YoYo</a></li>
		</ul>
		<div id="tabs-2">
			<!-- Accordion -->
			<div id="accordion">
				<div>
					...
					<div>
						...
						<p>
							<label for="fabric">Fabric: <span>(mainly for clothing, bedding)</span></label>
						...
						<p>
							<label for="compatibility">Compatibility <span>(used mainly for gear)</span></label>
							<input type="text" id="compatibility" name="compatibility" />
						</p>
						<p>
							<label for="batteries">Required Batteries <span>(used mainly for toys, electronics)</span></label>
							<input type="text" id="batteries" name="batteries" />
						</p>
						<p>
							<label for="author">Author <span>(for books)</span></label>
							<input type="text" id="author" name="author" />
						</p>
						<p>
							<label for="illustrator">Illustrator <span>(for books)</span></label>
							<input type="text" id="illustrator" name="illustrator" />
						</p>
						<p>
							<label for="rlevel">Reading Level <span>(for books)</span></label>
							<input type="text" id="rlevel" name="rlevel" />
						</p>
						<p>
							<label for="pagenos">Number of Pages <span>(for books)</span></label>
							<input type="text" id="pagenos" name="pagenos" />
						</p>
						<p>
							<label for="format">Format <span>(for books)</span></label>
