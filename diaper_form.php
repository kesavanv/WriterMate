	...
	<div id="content">
		...
		if(!empty($_POST["include1"])){
			if($includeCounter>1){
				...
				echo "<br/>".$oB."Includes: ".$cB.$_POST["include1"].$br."<br/>";
			}
		}
		if(!empty($_POST["note"])){
			echo "<br/>".$note."<br/>";
		...
		if(!empty($_POST["addnlFeature1"])){
			if($addnlFeatureCounter>1){
				...
				echo "<br/>".$oB."Additional Features: ".$cB.$_POST["addnlFeature1"].$br."<br/>";
			}
		}
		if(!empty($_POST["care1"])){
			if($careCounter){
				...
				echo "<br/>".$oB."Care: ".$cB.$_POST["care1"].$br."<br/>";
			}
		}
